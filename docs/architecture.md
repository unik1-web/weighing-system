...
Шапка сама переключается: на узкой ширине (<1024px) — иконки вкладок/бренда/пользователя; на широкой — полные подписи. Первая вкладка («Взвешивание») всегда доступна слева (полоса вкладок прокручивается от начала).
