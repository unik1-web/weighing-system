...
Шапка подстраивается по фактической ширине: полные подписи вкладок сохраняются, пока хватает места; сначала сжимаются название приложения и пользователь, иконки вкладок — в последнюю очередь. «Взвешивание» остаётся слева в полосе вкладок.
