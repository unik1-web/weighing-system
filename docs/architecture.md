...
Шапка сама переключается: на узкой ширине — иконки вкладок/бренда/пользователя; на широкой — подписи. Первая вкладка («Взвешивание») всегда доступна слева (полоса вкладок прокручивается от начала, без центрирования с обрезкой).
