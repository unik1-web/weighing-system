...
| На этой ветке оркестратора | **06** выполнен: задача `3aa7f0-yearly-db-archive` (см. [docs/3aa7f0-yearly-db-archive/](../3aa7f0-yearly-db-archive/)); ранее **05** / **04** / **03** / **02** |
| **Следующий прогон** | [07-photo-capture.md](07-photo-capture.md) |
...
```text
/orchestrator создай задачу на доске по docs/tasks/07-photo-capture.md и начни выполнять
```
