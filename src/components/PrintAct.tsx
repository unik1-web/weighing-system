...
<div style="font-family:Times New Roman,serif;font-size:10.5px;box-sizing:border-box;color:#000;width:100%;">
  <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:1.2mm;border-bottom:1px solid #000;padding-bottom:0.8mm;gap:3mm;">
    <div style="font-size:12px;font-weight:bold;white-space:nowrap;min-width:32%">${receiverLabel}</div>
  ...
  <div style="display:flex;gap:2mm;align-items:stretch;">
    <div style="flex:1 1 57%;padding-right:2mm;border-right:1px solid #555;">
      <table style="width:100%;border-collapse:collapse;font-size:10.5px;">
        <tbody>
          <tr><td style="padding:0 2mm 0.8mm 0;white-space:nowrap;color:#444;">Номер ТС:</td><td style="padding:0 0 0.8mm 0;font-weight:bold;">${t.vehicle_number || '—'}</td></tr>
          <tr><td style="padding:0 2mm 0.8mm 0;white-space:nowrap;color:#444;">Марка ТС:</td><td style="padding:0 0 0.8mm 0;font-weight:bold;">${t.vehicle_brand || '—'}</td></tr>
          <tr><td style="padding:0 2mm 0.8mm 0;white-space:nowrap;color:#444;">Прицеп:</td><td style="padding:0 0 0.8mm 0;font-weight:bold;">${t.trailer_number || '—'}</td></tr>
